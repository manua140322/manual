...
urlpatterns = [
    ...
    path('question/create/(?P<teststask_id>\d+)', views.question_create, name='question_create'),
    ...
    path('decision/index/', views.decision_index, name='decision_index'),
    path('decision/edit/<int:id>/', views.decision_edit, name='decision_edit'),
    path('decision/read/<int:id>/', views.decision_read, name='decision_read'),
